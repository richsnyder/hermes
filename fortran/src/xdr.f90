...
MODULE XDR
  ...
  TYPE, PUBLIC :: XDR_T
    ...
    CONTAINS
      ...
      PROCEDURE, PRIVATE :: XDR_GET_UINT64
      ...
      PROCEDURE, PRIVATE :: XDR_PUT_UINT64
...
CONTAINS
  ...
  FUNCTION XDR_GET_UINT64(SELF, VAL) RESULT(SUCCESS)
    CLASS(XDR_T) :: SELF
    TYPE(UINT64_T), INTENT(OUT) :: VAL
    LOGICAL :: SUCCESS

    INTEGER(KIND = C_INT64_T) :: X

    SUCCESS = XDR_GET_INT64(SELF, X)
    VAL = UINT64_T(X)
  END FUNCTION
  ...
  FUNCTION XDR_GET_UINT8_VECTOR(SELF, VALUES, LENGTH) RESULT(SUCCESS)
    CLASS(XDR_T) :: SELF
    TYPE(UINT8_T), DIMENSION(:), INTENT(OUT) :: VALUES
    INTEGER(KIND = C_SIZE_T), INTENT(IN) :: LENGTH
    LOGICAL :: SUCCESS
    ...
    ELSE
      DO N = 1, LENGTH
        VALUES(N) = UINT8_T(BSWAP_INT32_T(TRANSFER(SELF%BUFFER( &
            SELF%OFFSET + N * ELEMENT_SIZE - ELEMENT_SIZE : &
            SELF%OFFSET + N * ELEMENT_SIZE - 1_C_SIZE_T ), &
            X)))
      END DO
  ...
  FUNCTION XDR_GET_UINT16_VECTOR(SELF, VALUES, LENGTH) RESULT(SUCCESS)
    CLASS(XDR_T) :: SELF
    TYPE(UINT16_T), DIMENSION(:), INTENT(OUT) :: VALUES
    INTEGER(KIND = C_SIZE_T), INTENT(IN) :: LENGTH
    LOGICAL :: SUCCESS
    ...
    ELSE
      DO N = 1, LENGTH
        VALUES(N) = UINT16_T(BSWAP_INT32_T(TRANSFER(SELF%BUFFER( &
            SELF%OFFSET + N * ELEMENT_SIZE - ELEMENT_SIZE : &
            SELF%OFFSET + N * ELEMENT_SIZE - 1_C_SIZE_T ), &
            X)))
      END DO
  ...
  FUNCTION XDR_GET_UINT32_VECTOR(SELF, VALUES, LENGTH) RESULT(SUCCESS)
    CLASS(XDR_T) :: SELF
    TYPE(UINT32_T), DIMENSION(:), INTENT(OUT) :: VALUES
    INTEGER(KIND = C_SIZE_T), INTENT(IN) :: LENGTH
    LOGICAL :: SUCCESS
    ...
    ELSE
      DO N = 1, LENGTH
        VALUES(N) = UINT32_T(BSWAP_INT32_T(TRANSFER(SELF%BUFFER( &
            SELF%OFFSET + N * ELEMENT_SIZE - ELEMENT_SIZE : &
            SELF%OFFSET + N * ELEMENT_SIZE - 1_C_SIZE_T ), &
            X)))
      END DO
  ...
  FUNCTION XDR_GET_UINT64_VECTOR(SELF, VALUES, LENGTH) RESULT(SUCCESS)
    CLASS(XDR_T) :: SELF
    TYPE(UINT64_T), DIMENSION(:), INTENT(OUT) :: VALUES
    INTEGER(KIND = C_SIZE_T), INTENT(IN) :: LENGTH
    LOGICAL :: SUCCESS
    ...
    ELSE
      DO N = 1, LENGTH
        VALUES(N) = UINT64_T(BSWAP_INT64_T(TRANSFER(SELF%BUFFER( &
            SELF%OFFSET + N * ELEMENT_SIZE - ELEMENT_SIZE : &
            SELF%OFFSET + N * ELEMENT_SIZE - 1_C_SIZE_T ), &
            X)))
      END DO
  ...
  FUNCTION XDR_GET_UINT64_ARRAY(SELF, VALUES, LENGTH) RESULT(SUCCESS)
    CLASS(XDR_T) :: SELF
    TYPE(UINT64_T), DIMENSION(:), INTENT(OUT) :: VALUES
    INTEGER(KIND = C_SIZE_T), INTENT(OUT) :: LENGTH
    LOGICAL :: SUCCESS
    ...
    LENGTH = INT(H, KIND = C_SIZE_T)
    IF (SUCCESS .AND. LENGTH <= SIZE(VALUES)) THEN
      SUCCESS = XDR_GET_UINT64_VECTOR(SELF, VALUES, LENGTH)
    ELSE IF (SUCCESS) THEN
      SELF%OFFSET = SELF%OFFSET - HEADER_SIZE
      SUCCESS = .FALSE.
    END IF
  ...
  FUNCTION XDR_ALLOC_UINT8_ARRAY(SELF, VALUES, MAXLENGTH) RESULT(SUCCESS)
    CLASS(XDR_T) :: SELF
    TYPE(UINT8_T), DIMENSION(:), ALLOCATABLE, INTENT(OUT) :: VALUES
    INTEGER(KIND = C_SIZE_T), INTENT(IN) :: MAXLENGTH
    LOGICAL :: SUCCESS
  ...
  FUNCTION XDR_ALLOC_UINT16_ARRAY(SELF, VALUES, MAXLENGTH) RESULT(SUCCESS)
    CLASS(XDR_T) :: SELF
    TYPE(UINT16_T), DIMENSION(:), ALLOCATABLE, INTENT(OUT) :: VALUES
    INTEGER(KIND = C_SIZE_T), INTENT(IN) :: MAXLENGTH
    LOGICAL :: SUCCESS
  ...
  FUNCTION XDR_ALLOC_UINT32_ARRAY(SELF, VALUES, MAXLENGTH) RESULT(SUCCESS)
    CLASS(XDR_T) :: SELF
    TYPE(UINT32_T), DIMENSION(:), ALLOCATABLE, INTENT(OUT) :: VALUES
    INTEGER(KIND = C_SIZE_T), INTENT(IN) :: MAXLENGTH
    LOGICAL :: SUCCESS
  ...
  FUNCTION XDR_ALLOC_UINT64_ARRAY(SELF, VALUES, MAXLENGTH) RESULT(SUCCESS)
    CLASS(XDR_T) :: SELF
    TYPE(UINT64_T), DIMENSION(:), ALLOCATABLE, INTENT(OUT) :: VALUES
    INTEGER(KIND = C_SIZE_T), INTENT(IN) :: MAXLENGTH
    LOGICAL :: SUCCESS
  ...
  FUNCTION XDR_PUT_UINT64(SELF, VAL) RESULT(SUCCESS)
    CLASS(XDR_T) :: SELF
    TYPE(UINT64_T), INTENT(IN) :: VAL
    LOGICAL :: SUCCESS

    INTEGER(KIND = C_INT64_T) :: X

    X = INT8(VAL)
    SUCCESS = XDR_PUT_INT64(SELF, X)
  END FUNCTION
  ...
  FUNCTION XDR_PUT_UINT8_VECTOR(SELF, VALUES, LENGTH) RESULT(SUCCESS)
    CLASS(XDR_T) :: SELF
    TYPE(UINT8_T), DIMENSION(:), INTENT(IN) :: VALUES
    INTEGER(KIND = C_SIZE_T), INTENT(IN) :: LENGTH
    LOGICAL :: SUCCESS
    ...
    ELSE
      DO N = 1, LENGTH
        BUFFER => SELF%BUFFER( &
            SELF%OFFSET + N * ELEMENT_SIZE - ELEMENT_SIZE : &
            SELF%OFFSET + N * ELEMENT_SIZE - 1_C_SIZE_T )
        BUFFER = TRANSFER(BSWAP_INT32_T(INT(VALUES(N))), BUFFER)
      END DO
      SELF%OFFSET = SELF%OFFSET + LENGTH * ELEMENT_SIZE
      SUCCESS = .TRUE.
    END IF
  ...
  FUNCTION XDR_PUT_UINT16_VECTOR(SELF, VALUES, LENGTH) RESULT(SUCCESS)
    CLASS(XDR_T) :: SELF
    TYPE(UINT16_T), DIMENSION(:), INTENT(IN) :: VALUES
    INTEGER(KIND = C_SIZE_T), INTENT(IN) :: LENGTH
    LOGICAL :: SUCCESS
  ...
  FUNCTION XDR_PUT_UINT32_VECTOR(SELF, VALUES, LENGTH) RESULT(SUCCESS)
    CLASS(XDR_T) :: SELF
    TYPE(UINT32_T), DIMENSION(:), INTENT(IN) :: VALUES
    INTEGER(KIND = C_SIZE_T), INTENT(IN) :: LENGTH
    LOGICAL :: SUCCESS
  ...
  FUNCTION XDR_PUT_UINT64_VECTOR(SELF, VALUES, LENGTH) RESULT(SUCCESS)
    CLASS(XDR_T) :: SELF
    TYPE(UINT64_T), DIMENSION(:), INTENT(IN) :: VALUES
    INTEGER(KIND = C_SIZE_T), INTENT(IN) :: LENGTH
    LOGICAL :: SUCCESS
    ...
    ELSE
      DO N = 1, LENGTH
        BUFFER => SELF%BUFFER( &
            SELF%OFFSET + N * ELEMENT_SIZE - ELEMENT_SIZE : &
            SELF%OFFSET + N * ELEMENT_SIZE - 1_C_SIZE_T )
        BUFFER = TRANSFER(BSWAP_INT64_T(INT8(VALUES(N))), BUFFER)
      END DO
      SELF%OFFSET = SELF%OFFSET + LENGTH * ELEMENT_SIZE
      SUCCESS = .TRUE.
    END IF
  ...
  FUNCTION XDR_PUT_UINT64_ARRAY(SELF, VALUES, MAXLENGTH) RESULT(SUCCESS)
    CLASS(XDR_T) :: SELF
    TYPE(UINT64_T), DIMENSION(:), INTENT(IN) :: VALUES
    INTEGER(KIND = C_SIZE_T), INTENT(IN) :: MAXLENGTH
    LOGICAL :: SUCCESS
    ...
    ELSE
      SUCCESS = XDR_PUT_INT32(SELF, INT(LENGTH, KIND = C_INT32_T)) .AND. &
                XDR_PUT_UINT64_VECTOR(SELF, VALUES, LENGTH)
    END IF
  END FUNCTION
